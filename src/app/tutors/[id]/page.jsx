        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden">
            ...
            {[
              ...
              { icon: "☀️", label: "Mode", value: tutor.teachingMode ?? "Flexible" },
          ...
          <div className="rounded-xl border border-purple-200 bg-purple-50 px-4 py-3.5 flex flex-col gap-3">
            ...
            <button className="w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-800 text-purple-50 text-sm font-medium py-3 rounded-xl transition-colors">
              📆 Book a session
            </button>
          </div>
